...
def scrapURLs(source, url):
    ...
    for link in bsObj.find("div", {"class":"ctgLnb"}).findAll("a"):
...
def main():
    ...
    base_url = "http://www.sivillage.com/dispctg/initBrandCtg.siv?disp_ctg_no=1903006496"
    bUrl = ""
    ...
    category_list = driver.find_elements_by_css_selector("ul.lst ul.lyr a")
